#!/usr/bin/env python3
"""
Module that defines a function to find a snippet of text within a
reference document that answers a given question, using a
...
def question_answer(question, reference):
    ...
    Returns:
        str: a string containing the answer, or None if no answer
            is found.
    """
