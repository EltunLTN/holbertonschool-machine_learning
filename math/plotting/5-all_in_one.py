...
def all_in_one():
    """Plot all 5 previous graphs in one 3x2 figure."""
    y0 = np.arange(0, 11) ** 3
    ...
    ax0.plot(y0, 'r')
    ax0.set_xlim(0, 10)
    ax0.set_xlabel("", fontsize='x-small')
    ax0.set_ylabel("", fontsize='x-small')
    ...
    # Plot 3: exponential decay comparison
    ...
    # Plot 4: histogram (spans two columns)
